...
public class GenericKeywords {
	...
	public void openBrowser(){
		...
		if(prop.getProperty("gridRun").equals("Y")) {
			...
			if(browser.equals("Mozilla")){
				...
				// invoke profile
				System.setProperty("webdriver.gecko.driver", "D:\\Selenium\\drvers_browsers\\geckodriver-v0.21.0-win64\\geckodriver.exe");
				driver = new FirefoxDriver();
			}else if(browser.equals("Chrome")){
				// init options
				System.setProperty("webdriver.chrome.driver", "D:\\Selenium\\drvers_browsers\\chromedriver_win32\\chromedriver.exe");
	...
	public WebElement getObject(String objectKey){
		...
		else if(objectKey.endsWith("_text"))
