...
public class ZipAndSendMail
{
	...
	static String[] toEmails = {"shalinigupta2006@gmail.com"};
	static String fromUser = "qashalini0602";//just the id alone without @gmail.com
	static String password = "shalini2006";
